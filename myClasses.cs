...
namespace StoreApp
{
    ...
    public class ShopCategory // Aman
    {
    ...
    public class ShopProduct : INotifyPropertyChanged // Aman
    {
    ...
    public class cartItem : INotifyPropertyChanged //Naman
    {
